...
- Retry on timeout for Supabase API calls (handles cold-start delays)
- Document that publish requires a public GitHub repository

### Changed

- Homepage URL updated to https://updose.dev
...
- GitHub Sponsors workflow and README sponsors section
- GitHub funding configuration

### Changed

- Highlight website URL in search results footer
...
[1.1.0]: https://github.com/Alchemist85K/updose/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/Alchemist85K/updose/compare/v0.4.0...v1.0.0
